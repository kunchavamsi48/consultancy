...
<body>
    ...
    <div  style="font-size:bolder" id="head" class="fit_img-services">
            We provide a multitude of services in various fields
    </div>
    <div class="container0">
<br>
<p id="tx1">
    We follow a service exclusive model which helps accelerate the evolution of an enterprise in achieving improved outcomes with technology-enabled and consumption-based services.
</p>
<br>
    <hr>
    <br>
    <p id="tx1">
     We deliver you optimized business processes, enriched insights, smart applications and intelligent infrastructure.
 </p>
 <br>
     <hr>
     <br>
     <p id="tx1">
     We do this by leveraging our expertise in integrating software, infrastructure, business processes, professional services, and industry ecosystems.
    </p>
    <br>
    </div>
    <br>
...
<p id="txt1">
In today’s digital world, data, analytics and AI play a key role in transforming native business operations, creating new business models and unleashing process improvements. Acuerdo's data, analytics and AI services, enable organizations to deliver value across the customers’ journey by empowering users with more agile and intuitive processes.
        </p>
        <br>
